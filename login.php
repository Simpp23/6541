...
<body>
    <div class="login-container">
        <div class="login-image">
            <img src="images/landokmai.png" alt="Background image">
        </div>
        <div class="login-form">
            ...
            <form action="login_script.php" method="post">
                ...
                <div style="margin-top: 20px; text-align: center;">
                    <button type="button" style="background-color: #3b5998;
                        color: white; width: 100%; margin-bottom: 10px;">Connect with Facebook</button>
                    <button type="button" style="background-color: #db4a39;
                        color: white; width: 100%;">Connect with Google</button>
                </div>
            </form>
